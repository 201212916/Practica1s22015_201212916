...
public class E_Juego extends javax.swing.JFrame implements Runnable {

	public E_ObjetosMenu objetosMenu;
        public String minutos, segundos, horas;
    ...
    public void ejecutar(){
        if(!objetosMenu.carga.getJugador().esVacio()){
        jLabel4.setText(objetosMenu.carga.getPojoPersonaje().getNombreJ());
        jLabel6.setText(objetosMenu.carga.getPojoPersonaje().getNombre());
        jLabel8.setText(String.valueOf(objetosMenu.carga.getPojoPersonaje().getMonedas()));
        jLabel10.setText(String.valueOf(objetosMenu.carga.getPojoPersonaje().getVida()));
        }
    }
    ...
    public void run(){
        ...
        jLabel2.setText(String.valueOf(hor + " : " + min + " : " + seg));
        seg++;
        if(min>=59){
            min =0;
            hor++;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        objetosMenu.jRadioButton3.setSelected(true);
        objetosMenu.jRadioButton4.setSelected(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        objetosMenu.jRadioButton3.setSelected(true);
        objetosMenu.jRadioButton4.setSelected(false);
