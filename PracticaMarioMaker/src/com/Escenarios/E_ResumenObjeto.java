...
public class E_ResumenObjeto extends javax.swing.JFrame {
    
    CargaObjetos carga;
    
    public E_ResumenObjeto() {
        initComponents();
    ...
    public void actualizar(){
         jLabel10.setText(String.valueOf(carga.getJugador().getSize()));
        jLabel18.setText(String.valueOf(carga.getGoomba().getSize()));
        jLabel19.setText(String.valueOf(carga.getKoopa().getSize()));
        jLabel20.setText(String.valueOf(carga.getSuelo().getSize()));
        jLabel24.setText(String.valueOf(carga.getPared().getSize()));
        jLabel21.setText(String.valueOf(carga.getMoneda().getSize()));
        jLabel22.setText(String.valueOf(carga.getVida().getSize()));
        jLabel23.setText(String.valueOf(carga.getCastillo().getSize()));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Resumen de objetos");

        jLabel2.setText("Personaje:");

        jLabel3.setText("Goomba:");

        jLabel4.setText("Koopa:");

        jLabel5.setText("Suelo:");

        jLabel6.setText("Pared:");

        jLabel7.setText("Moneda:");

        jLabel8.setText("Hongo vida:");
