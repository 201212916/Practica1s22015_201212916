...
public class ArchivoRecuperarOrtogonal {

	CargaObjetos carga;

	public ArchivoRecuperarOrtogonal() {
		carga = new CargaObjetos();
	}

	public void generarArchivo() {
		String file = "src/com/Archivos/RecuperarOrtogonal.txt";
		String respuesta = "";
		...
		try {
			...
			respuesta += this.preGenerarArchivo(carga.getRecuperarOrtogonal(), "Recuperar_Ortogonal");
	...
	private void crearDibujo(String path) {
		try {
			...
			String fileOutputPath = "src/com/Archivos/RecuperarOrtogonal.jpg";
